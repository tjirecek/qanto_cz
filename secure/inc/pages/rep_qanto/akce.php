        ...
        <div class="card shadow mb-4" data-rep-akce>
            ...
            <div class="card-body">
                <form method="post" enctype="multipart/form-data" class="row g-3" autocomplete="off">
                    ...
                    <div class="col-md-6"><label for="akce_pdf_file" class="form-label">PDF ke stažení</label><input type="file" name="pdf_file" id="akce_pdf_file" class="form-control" accept="application/pdf,.pdf"><?php if ($pdfPath !== ''): ?><div class="form-text"><a href="<?= rep_akce_e(rep_akce_file_url($pdfPath)) ?>" target="_blank" rel="noopener">aktuální PDF</a><?php if ((string)($formOffer['pdf_original_name'] ?? '') !== ''): ?> - <?= rep_akce_e($formOffer['pdf_original_name']) ?><?php endif; ?></div><?php endif; ?></div>
