...
if ($staticTextTitle === null || $staticTextTitle === '') {
    $staticTextTitle = (string)($pagetitle ?? ui_text('site.name'));
        ...
        <div class="detail-page-layout">
            <article class="static-text-page__panel detail-page-content">
                ...
                <div class="static-text-page__content">
                    <?= $staticTextBody !== null && $staticTextBody !== '' ? $staticTextBody : '<p>' . htmlspecialchars(ui_text('common.text_unavailable'), ENT_QUOTES, 'UTF-8') . '</p>' ?>
                </div>
            </article>
