...
`secure/inc/settings/cron_vypis.php` je projektovy vypis cron uloh. Kazdy projekt muze mit vlastni cron seznam a soubor se neporovnava jako shared/admin kandidát.
