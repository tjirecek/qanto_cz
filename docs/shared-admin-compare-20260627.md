...
| QRS_QANTO_CZ | Shared/System candidates | SHARED_SYSTEM | 70 | 67 | 3 | 0 | 0 | Shared/admin baseline inside repository structure. |
...
| Area / Path | Finding |
| --- | --- |
| Shared/System candidates | 3 otevrenych rozdilu proti sekundarnim projektum; review pred prenosem. |
